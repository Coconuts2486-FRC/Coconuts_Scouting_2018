...
public class Entry_Page_Setup {
	...
	public void Clear() {
		...
		Entry_Page.Auto_leaver.setText("0");
		Entry_Page.Auto_switch.setText("0");
		Entry_Page.Teleop_leaver.setText("0");
	...
	//Auto--------------------------------------------------------------------
	data.Auto_blocksInLever=Integer.parseInt(Entry_Page.Auto_leaver.getText());
	...
	//Teleop------------------------------------------------------------------
	data.Teleop_blocksInLever=Integer.parseInt(Entry_Page.Teleop_leaver.getText());
	...
	public void LoadData(int ArrayLocation) {
		...
		Entry_Page.Auto_leaver.setText(Integer.toString(Game_Array.GameList.get(ArrayLocation).Auto_blocksInLever));
		Entry_Page.Auto_switch.setText(Integer.toString(Game_Array.GameList.get(ArrayLocation).Auto_blocksInSwitch));
		Entry_Page.Teleop_leaver.setText(Integer.toString(Game_Array.GameList.get(ArrayLocation).Teleop_blocksInLever));
